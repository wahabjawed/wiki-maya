...
def calcFeatures(params):
    ...
    filename = os.path.join(fileDir, "../data/2017_english_wikipedia_quality_dataset/revisiondata/"+str(rev['article_revid']))
...
if __name__ == "__main__":
    ...
    'automated_readability_index', 'linsear_write_formula', 'dale_chall_readability_score', 'gunning_fog', 'lix', 'rix',
    ...
    final.to_csv("../data/2017_english_wikipedia_quality_dataset/datasets/training-set-n1.csv")