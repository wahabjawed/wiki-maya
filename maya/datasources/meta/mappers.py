...
.. autoclass:: maya.datasources.meta.mappers.map

.. autoclass:: maya.datasources.meta.mappers.lower_case

.. autoclass:: maya.datasources.meta.mappers.derepeat

.. autoclass:: maya.datasources.meta.mappers.abs
"""
...
class map(Datasource):
    """
    Returns a :class:`maya.Datasource` that applies a function over
...
class lower_case(map):
    """
    Returns a :class:`maya.Datasource` that lower cases a list of `str`
    returned by another datasource.

    :Parameters:
        strs_datasource : :class:`maya.Datasource`
...
class derepeat(map):
    """
    Returns a :class:`maya.Datasource` that prevents a list of `str` from
...
class de1337(map):
    """
    Returns a :class:`maya.Datasource` that converts numbers in the
...
class abs(map):
    """
    Returns a :class:`maya.Datasource` that converts a list of numeric
