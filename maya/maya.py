"""
This script provides access to a set of utilities for maya

* precached -- Starts a daemon that requests scores for revisions as they happen
* score_revisions -- Scores a set of revisions using an maya API
* stress_test -- Scores a large set of revisions at a configurable rate
* test_api -- Runs a series of tests against a live maya API
...
def main():
    ...
    try:
        sys.path.insert(0, ".")
        module = import_module(module_path, package="maya")
    except ImportError:
