...
class RandomForest:
    ...
    def learn(self):
        ...
        # from random forest
        self.features_imp = ['linsear_write_formula', 'dale_chall_readability_score', 'rix',
                         'dale_chall_readability_score_v2', 'reading_time',
        ...
        # scores = cross_val_score(self.clf, self.train[self.features], y, cv=5)
        ...
        # scores2 = cross_val_score(self.clf2, self.train[self.features_imp], y, cv=5)
