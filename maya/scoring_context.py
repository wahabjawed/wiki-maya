...
class ServerScoringContext(ScoringContext):
    ...
    of the model_info actions (e.g. :class:`maya.scoring_systems.CeleryQueue`).
...
class ClientScoringContext(ScoringContext):
    ...
    (e.g. :class:`maya.scoring_systems.CeleryQueue`).  This ScoringContext
