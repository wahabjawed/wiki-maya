"""
Runs a basic test against an maya api assuming that it supports the standard
configuration "/v2/testwiki/revid/..."

:Usage:
    test_api -h | --help
    test_api <maya-url> [--debug]

:Options:
    -h --help        Prints this documentation
    <maya-url>       URL of base maya webserver
...
def main(argv=None):
    ...
    make_request(
        ores_url, "/v1/scores/testwiki/2342342/revid/", is_json=True,
        equal_to={"testwiki": {
    ...
    make_request(
        ores_url,
        ("/v1/scores/testwiki/2342342/revid/?" +
    ...
    make_request(
        ores_url,
        "/v1/scores/testwiki/2342342/revid/?features&feature.delay=16",
        is_json=True,
        equal_to={"testwiki": {
            "models": {"revid": {"version": "0.0.0"}},
            "scores": {"2342342": {
    ...
    make_request(
        ores_url,
        "/v1/scores/testwiki/?revids=1205|2309&feature.delay=2&features",
        is_json=True,
        equal_to={"testwiki": {
            "models": {"revid": {"version": "0.0.0"}},
            "scores": {
    ...
    make_request(
        ores_url,
        "/v1/scores/testwiki/?revids={0}".format(revids_param),
        is_json=True,
        http_code=400,
        equal_to={"error": {
            "code": "bad request",
