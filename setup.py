...
about_path = os.path.join(os.path.dirname(__file__), "maya/about.py")
exec(compile(open(about_path).read(), about_path, "exec"))

if sys.version_info <= (3, 0):
    print("maya needs Python 3 to run properly. Your version is " + platform.python_version())
    sys.exit(1)
...
setup(
    ...
    extras_require={
        # Install maya[redis] if your deployment will use the Redis scoring
